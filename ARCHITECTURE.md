...
The Cactri 0.4.x lineage branches from 0.2.2. The 0.3.x hybrid/blocked partition samplers
...
- `cactri.pruning`: post-fit tree pruning, read-impurity split-back, and pruned-tree refinement utilities.
